...
const FuturePrice = () => {
  ...
  return (
    <div className='future' style={{backgroundImage:'url("https://img.freepik.com/free-photo/tomatoes-tomatoes-lemon-leaves-garlic-bottle-oil-tree-branches_140725-74118.jpg")',backgroundSize:"cover"}}>
      ...
      <div>
        <label className='lab1' style={{marginTop:"30px",marginLeft:"640px"}}>
          Date:
          <input
            type="date"
            value={date}
